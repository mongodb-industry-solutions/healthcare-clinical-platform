...
interface PatientDetailProps {
  patient: Patient360
  vitalsTimeSeries: VitalsTimeSeries[]
}

export function PatientDetail({ patient, vitalsTimeSeries }: PatientDetailProps) {
    ...
    <div className="flex flex-col gap-6 p-6">
      ...
      <div className="grid gap-6 lg:grid-cols-3">
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <Card>
            <CardHeader className="pb-2">
              <CardTitle className="text-base font-medium">Vitals Trend (24h)</CardTitle>
              <CardDescription>
        ...
        <div className="space-y-6">
          ...
          <Card>
            <CardHeader className="pb-2">
              ...
              <CardDescription>
                Factors affecting alert thresholds
              </CardDescription>
            </CardHeader>
            <CardContent>
              <div className="space-y-2">
    ...
    <div className={cn(
      ...
      <div className="flex-1 min-w-0">
        <div className="flex items-center gap-2">
          ...
          <Badge variant={isCritical ? "destructive" : "default"} className={cn(
            "text-xs",
            !isCritical && "bg-warning text-warning-foreground"
          )}>
            {alert.severity}
          </Badge>
        </div>
...
function VitalCard({
  ...
  return (
    <div className={cn(
      ...
      {contextNote && (
        <div className="text-[10px] text-primary mt-0.5">{contextNote}</div>
      )}
    </div>
  )
}
...
function ContextFlag({
  ...
  return (
    <div className={cn(
      ...
      <div>
        <div className={cn(active ? "font-medium" : "text-muted-foreground")}>
          {label}
        </div>
        {active && (
